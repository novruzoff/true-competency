...
\restrict SwDzf4kW1U2wocv94DNv1vkKyV7OXJrmKw097B7AFK1ed8z7ovSSFKNYpdNc1ip
...
--
-- Name: competency_topics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: doctor_students; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.doctor_students (
 ...
 SELECT ca.student_id,
    ...
    COALESCE(a.answered_questions, 0) AS answered_questions,
        CASE
            ...
            ELSE (round(((100.0 * (COALESCE(a.answered_questions, 0))::numeric) / (q.total_questions)::numeric)))::integer
        END AS pct
   FROM ((public.competency_assignments ca
     ...
     LEFT JOIN ( SELECT sa.student_id,
            cq.competency_id,
            (count(DISTINCT sa.question_id))::integer AS answered_questions
...
--
-- Name: competency_topics competency_topics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.competency_topics
    ADD CONSTRAINT competency_topics_pkey PRIMARY KEY (competency_id, topic_id);


--
-- Name: doctor_students doctor_students_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_pkey PRIMARY KEY (doctor_id, student_id);


--
-- Name: doctor_students doctor_students_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_unique UNIQUE (doctor_id, student_id);


--
-- Name: doctor_students doctor_students_unique_pair; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_unique_pair UNIQUE (doctor_id, student_id);
...
--
-- Name: ix_competency_topics_by_comp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_competency_topics_by_comp ON public.competency_topics USING btree (competency_id);


--
-- Name: ix_competency_topics_by_topic; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_competency_topics_by_topic ON public.competency_topics USING btree (topic_id);
...
CREATE TRIGGER on_auth_user_updated AFTER UPDATE OF email, raw_user_meta_data ON auth.users FOR EACH ROW EXECUTE FUNCTION public.sync_profile_from_auth();
...
--
-- Name: competency_topics competency_topics_competency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.competency_topics
    ADD CONSTRAINT competency_topics_competency_id_fkey FOREIGN KEY (competency_id) REFERENCES public.competencies(id) ON DELETE CASCADE;


--
-- Name: doctor_students doctor_students_doctor_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_doctor_fk FOREIGN KEY (doctor_id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: doctor_students doctor_students_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: doctor_students doctor_students_student_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_student_fk FOREIGN KEY (student_id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: doctor_students doctor_students_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_students
    ADD CONSTRAINT doctor_students_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: profiles insert self profile; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_select_admins; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY profiles_select_admins ON public.profiles FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
...
CREATE POLICY profiles_update_admin ON public.profiles FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.app_admins a
  WHERE (a.user_id = auth.uid())))) WITH CHECK (true);


--
-- Name: profiles profiles_update_self_nonrole; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY profiles_update_self_nonrole ON public.profiles FOR UPDATE TO authenticated USING ((auth.uid() = id)) WITH CHECK (((auth.uid() = id) AND (role = ANY (ARRAY['trainee'::public.user_role, 'instructor'::public.user_role, 'committee'::public.user_role])) AND (NOT is_admin)));
...
\unrestrict SwDzf4kW1U2wocv94DNv1vkKyV7OXJrmKw097B7AFK1ed8z7ovSSFKNYpdNc1ip
